...
void on_remember_bluetooth_audio(GtkWidget* widget, gpointer user_data);
void on_connect_speaker(GtkWidget* widget, gpointer user_data);
...
void on_calibration_stop(GtkWidget* widget, gpointer user_data);
void on_save_calibration(GtkWidget* widget, gpointer user_data);
void on_cal_meters_changed(GtkEditable* editable, gpointer user_data);
void on_cal_new_changed(GtkEditable* editable, gpointer user_data);
