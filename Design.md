...
The tones generated should be piano C6,F6,A6 when behind and F6,D6,C6 when ahead.The tone generator should apply a 5ms fade-in/fade-out envelope at every tone-to-silence and silence-to-tone transition
